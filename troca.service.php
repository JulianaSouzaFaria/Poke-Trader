...
class TrocaService{
	...
	public function __construct(Conexao $conexao, Troca $troca, $tabela = "troca_pokemon") 
	{
	...
	{
		$query = 'insert into '.$this->tabela.'(nome_pokemon,base_experience)values(:nome_pokemon,:base_experience)';
