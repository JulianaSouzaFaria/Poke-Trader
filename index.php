      ...
      <div class="col-md-6">
        ...
        <div class="card-body font-weight-bold text-center" style="border: 1px solid #434D6B">             
          <div class="form-group">
            ...
            <input type="number" class="form-control " id="pok11" placeholder="ID do seu Pokemon" >
            ...
            <input type="number" class="form-control" id="pok12" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok13" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok14" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok15" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok16" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
      ...
      <div class="col-md-6">          
        <div class="card-body font-weight-bold text-center" style="border: 1px solid #434D6B">            
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="pok21" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok22" placeholder="ID do seu Pokemon">
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok23" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok24" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok25" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
            ...
            <input type="number" class="form-control" id="pok26" placeholder="ID do seu Pokemon" >
            <div class="button floatLeft">
